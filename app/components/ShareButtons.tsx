    ...
    <section className="mt-10 border-y border-zinc-200 py-6">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <button
          ...
          className="flex h-11 w-11 items-center justify-center rounded-full border border-zinc-300 text-zinc-700 transition-all duration-200 hover:-translate-y-1 hover:border-orange-500 hover:text-orange-500"
        >
          🔗
        </button>
