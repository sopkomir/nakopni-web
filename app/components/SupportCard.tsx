...
export default function SupportCard({
  ...
  return (
    <section
      className={
        isSidebar
          ? "rounded-3xl border border-zinc-200 bg-zinc-50 p-6"
          : "my-20 rounded-3xl border border-zinc-200 bg-zinc-50 p-8 md:p-10"
      }
    >
      {isSidebar ? (
        <div className="text-center">
          ...
          <Image
            ...
            width={180}
            height={180}
            className="mx-auto rounded-2xl bg-white p-3 shadow"
          />

          <button
            onClick={copyIBAN}
            className="mt-5 w-full rounded-xl bg-orange-500 hover:bg-orange-600 transition px-5 py-3 font-semibold text-white shadow-lg"
          >
            📋 Skopírovať IBAN
          </button>
